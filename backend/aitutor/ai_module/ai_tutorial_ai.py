...
class AITutorialGenerator:
    ...
    def _create_prompt(self) -> str:
        ...
        return (
            ...
            "[2 Модуль]: (В [Вывод 3] НЕ УКАЗЫВАТЬ итоговый вывод программы!!!)Текст задачи, требованния к вводу и  к выводу(Важно! В требованиях к выводу не должно быть итогового вывода программы! Только описание этого вывода.). Подструктура: [Текст задачи 2]:, [Ввод 2]:, [Вывод 2]:\n" +
            "[3 Модуль]:  Ввод и вывод задачи из 2 модуля(Важно! вывод будет использоваться для проверки правильности выполненной задачи, поэтому должен из себя представлять исключительно вывод программы, не имея в себе никаких лишних комментариев). Подструктура: [Ввод 3]:, [Вывод 3]:\n" +
