...
class AITutorialGenerator:
    ...
    def _create_prompt(self) -> str:
        ...
        return (
            ...
            "Постарайся дать пользователю интересную задачу, с помощью которой он точно запомнит туториал, что он прочитал. Важно! Старайся в одной задаче дать сразу несколько аспектов, представленных в туториале."
            ...
            "[2 Модуль]: Текст задачи, требованния к вводу и  к выводу(Важно! В требованиях к выводу не должно быть итоговых значений.). Подструктура: [Текст задачи 2]:, [Ввод 2]:, [Вывод 2]:\n" +
